...
import 'package:course/presentation/pages/setting/widgets/logout_confirm_dialog.dart';
import 'package:course/presentation/widgets/profile_avatar.dart';
import 'package:course/presentation/pages/setting/widgets/settings_menu_item.dart';
...
class SettingsPage extends HookConsumerWidget {
  ...
  Widget _buildBody(BuildContext context, WidgetRef ref, ProfileState state) {
    ...
    if (state.hasError && state.username == null) {
      return RefreshIndicator(
        child: Center(child: Text('Không thể tải thông tin.')),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          // Avatar section
          _buildAvatarSection(context, username, '', state.avatarUrl),
